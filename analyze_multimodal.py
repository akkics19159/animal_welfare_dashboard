...
REPORT_FILE = BASE_DIR / "sample_multimodal_report.csv"
...
def main():
    ...
    try:
        ...
        save_loudest_audio_segment(str(VIDEO_PATH), audio_clip_path)
    except Exception as exc:
        audio_clip_path = None
    ...
    generate_report([summary], filename=str(REPORT_FILE))
